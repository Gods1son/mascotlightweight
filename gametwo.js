...
function winningFunction(){
    ...
    if(counter == (faces.length)){
        navigator.notification.alert("Congrats, you have come to the end of the game. Thanks for playing and expect update with more levels", null, "9ja Mascots", "I did it!!!");
        return;
    }
   ...
   var nice = Math.floor(Math.random() * 20);
    var picture = Math.floor(Math.random() * 6);
    comment = correctG[nice];
    document.getElementById("commenter").innerHTML ="You Passed: " + comment;
    document.getElementById("pictures").src = "images/"+picture+".gif";
    $('#myBtn').click();
    addStage();
   // alert(comment);
